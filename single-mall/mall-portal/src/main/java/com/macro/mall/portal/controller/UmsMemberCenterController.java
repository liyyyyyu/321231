 ...
 *     ||        ||  \)     
 *     (_\       (_\
 * @author ：* @date ：Created in 2019/12/30 19:40
 * @version: V1.0
 * @slogan: 时间证明一切
 * @description: 会员中心
 **/
@Api(tags = "UmsMemberCenterController",description = "会员中心管理操作#lhy添加")
@RestController
...
public class UmsMemberCenterController {
    ...
    @ApiOperation(value = "获取会员信息#lhy添加",notes = "不包含会员等级信息,会员需要被拆分成微服务")
    ...
    @ApiOperation(value = "获取会员详细信息包含会员等级信息#lhy添加",notes = "会员需要被拆分成微服务")
    ...
    @ApiOperation(value = "修改个人信息#lhy添加",notes = "会员需要被拆分成微服务")
